...
const TaskDetailModal = ({ task, onClose, onEdit, onDelete }) => {
  ...
  const getPriorityConfig = priority => {
    const configs = {
      ...
      URGENT: { label: 'Urgente', color: 'text-red-800', icon: '‼' },
    };
          ...
          <div className="grid grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div
                  className={`inline-flex items-center gap-2 px-3 py-2 rounded-lg ${statusConfig.bgColor} ${statusConfig.textColor} font-medium text-sm`}
                >
                  {statusConfig.label}
                </div>
              </div>
              ...
              {task.project && (
                <div>
                  <span
                    className="inline-block px-3 py-2 text-white text-sm font-semibold rounded-md"
              ...
              {task.priority && (
                <div>
                  ...
                  <div
                    className={`flex items-center gap-2 ${priorityConfig.color} font-medium`}
                  >
              ...
              <div className="pt-4 border-t border-gray-200">
                ...
                <div className="text-sm text-gray-500">
                  {task.createdAt || task.createdAtRaw
                    ? new Date(
                        task.createdAt || task.createdAtRaw,
                      ).toLocaleDateString('pt-BR')
                    : 'Hoje'}
...
TaskDetailModal.propTypes = {
  task: PropTypes.shape({
    ...
    dueDateRaw: PropTypes.string,
    estimatedMin: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
    // actualMin: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
